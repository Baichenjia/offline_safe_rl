...
def readParser():
    ...
    parser.add_argument('--algo', default="ppo_lag",
        help='Must be one of mopo, gambol, sac, cql, ppo_lag')
...
def main():
    ...
    if args.algo == 'ppo_lag':
        agent = PPOLag(env.observation_space.shape[0], env.action_space)
