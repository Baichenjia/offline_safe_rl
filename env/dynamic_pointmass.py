...
class PointMass(gym.Env):
    ...
    def step(self, action):
        ...
        # the obstacle will chase the point mass
        self.state[2:4] = (self.state[:2] - self.state[2:4]) / 3 + self.state[2:4]
        self.state[2:4] = np.clip(self.state[2:4], 0.3, 0.7)
